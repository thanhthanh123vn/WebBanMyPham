window.onload = function() {
    ...
    if (loadData) {
        ...
        if (useraddress.length > 0)  useraddress[0].innerHTML =  `${addressData.address.numberHours} ${  addressData.address.address}, ${addressData.address.district}, ${addressData.address.city}`;
    }
};
